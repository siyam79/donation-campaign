...
const Banner = ({ handleSearch }) => {
    ...
    return (
        <div>
            <div className="relative grid  lg:w-full flex-col items-end justify-center overflow-hidden rounded-xl text-center">
                <div className="absolute inset-0 m-0 h-full w-full  overflow-hidden  opacity-5  bg-transparent bg-[url('https://i.ibb.co/bQZw9q6/Rectangle-4281.png')] bg-cover bg-clip-border bg-center ">
